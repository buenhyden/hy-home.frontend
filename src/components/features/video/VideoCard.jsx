        ...
        <div className="group relative bg-slate-800 rounded-xl overflow-hidden border border-slate-700/50 hover:border-indigo-500/50 transition-all duration-300 hover:shadow-xl hover:shadow-indigo-500/10 hover:-translate-y-1">
            ...
            <div className="aspect-video bg-slate-900 relative overflow-hidden">
                <img
                    ...
                    onError={(e) => { e.target.src = '[https://via.placeholder.com/640x360?text=No+Image](https://via.placeholder.com/640x360?text=No+Image)'; }}
                />
                <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <a href={video.url} target="_blank" rel="noreferrer" className="bg-white/20 backdrop-blur-md p-4 rounded-full text-white hover:bg-white hover:text-indigo-600 transition-colors transform scale-90 group-hover:scale-100">
